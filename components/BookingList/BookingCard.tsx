...
function getStateCard(
  ...
  if (state === 2) {
    return (
      <div tw="flex flex-row space-x-1">
        <BasicStateCard hexColor="#03BD36">Terkonfirmasi</BasicStateCard>
      </div>
    );
  } else if (state === 5) {
    return (
      <div tw="flex flex-row space-x-2 items-center">
        <BasicStateCard hexColor="#03BD36">Selesai</BasicStateCard>
        {/* Add stars */}
      </div>
    );
  } else if (state === 3) {
