    ...
    <div tw="flex flex-col items-start justify-center w-full">
      ...
      >
        ...
        <p
          ...
          `}
        >
          {formatDate(props.date)} &nbsp;•&nbsp; {formatHour(props.startTime)} -{' '}
          {formatHour(props.endTime)}
        </p>
        <p
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div tw="flex flex-col justify-center w-full mt-3">
            ...
            <Rating
              ...
              `}
              emptySymbol={
                <img src="../../icons/review-star-empty.png" className="icon" />
              }
              fullSymbol={
                <img
                  src="../../icons/review-star-filled.png"
                  className="icon"
                />
              }
              onChange={(newValue) => {
