...
import 'twin.macro'
import StarRating from './goldenStarComponent'
...
const Card: React.FC<CardProps> = ({title, distance, address, openHour, closeHour, rating}) => {
    return (
        <div tw="text-left">
            <div tw="text-xl capitalize mb-0 font-bold">
                {title}
            </div>
            ...
            <div tw="mt-1 mb-0 flex items-center">
                ...
                <p tw="text-xs ">Jam Buka: {openHour} - {closeHour} </p>
            </div>
            <div tw="mt-3">
