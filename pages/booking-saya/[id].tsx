                    ...
                    <div tw='mx-6'>
                        ...
                        <div tw='my-5'>
                            ...
                            <div tw='mx-4'>
                                <div tw='flex justify-between space-x-4'>
                                    ...
                                    <p tw='font-bold'>{moment(booking?.date, "YYYY-MM-DDTHH:mm:ss").utc().format('dddd, DD MMM YYYY')}</p>
                                </div>
                                <div tw='flex justify-between space-x-4'>
                                    <p tw='text-[#666666]'>Waktu check-in</p>
                                    <p tw='font-bold'> {moment(booking?.start_time, "YYYY-MM-DDTHH:mm:ss").format('HH:mm')} WIB</p>
                                </div>
                                <div tw='flex justify-between space-x-4'>
                                    <p tw='text-[#666666]'>Waktu check-out</p>
                                    <p tw='font-bold'>{moment(booking?.end_time, "YYYY-MM-DDTHH:mm:ss").format('HH:mm')} WIB</p>
                                </div>
                            </div>
                        </div>
                                ...
                                {booking?.items.map((item: any, key:any) => (
                                    <div>
                                        <div tw='flex justify-between space-x-4'>
                                            ...
                                            <p tw='font-bold text-[#666666]'> {currency(item.price, {
                                                                                    symbol: 'Rp',
                                                                                    decimal: ',',
                                                                                    separator: '.',
                                                                                    precision: 0
                                        ...
                                        <div tw='flex justify-between space-x-4'>
                                            ...
                                            <p tw='font-bold'> {currency(item.total_price, {
                                                                            symbol: 'Rp',
                                                                            decimal: ',',
                                                                            separator: '.',
                                                                            precision: 0
                        ...
                        <div tw='mx-4 mb-8'>
                            <div tw='flex justify-between space-x-4'>
                                ...
                                <p tw='font-bold'>{currency(booking?.total_price, {
                                                                    symbol: 'Rp',
                                                                    decimal: ',',
                                                                    separator: '.',
                                                                    precision: 0
                        ...
                        <div tw='mx-4'>
                            <div tw='flex flex-col items-center space-y-4'>
                                {
                                    parseBookingStatusButton(booking?.status) ? <a tw='block w-full' href={booking?.invoices_url}><Button>Bayar</Button></a> :  <Button disabled={true}>Bayar</Button>
                                }
                            </div>
                        </div> 
                    </div>
...
const parseBookingStatus: (status:number) => React.ReactNode = (status) => {
    switch (status) {
        case 0 :
            return <p tw='text-xs text-left font-bold text-[#003366]'>Menunggu Konfirmasi Pemilik Tempat</p>
        case 1 :
            return <p tw='text-xs text-left font-bold text-[#FE3131]'>Menunggu Pembayaran</p>
        case 2 :
            return <p tw='text-xs text-left font-bold text-[#03BD36]'>Terkonfirmasi</p>
        case 3 :
...
const parseBookingStatusButton: (status:number) => React.ReactNode = (status) => {
    switch (status) {
        case 1:
            return true
        default:
