            ...
            <Layout>
                <div tw="pt-0 pb-16 flex flex-col items-center min-h-screen w-full">
                    ...
                    <div tw="px-6 py-5 flex flex-col w-full">
                        {status === 'success' &&
                            <Card title={data.data.name} distance={data.data.distance} address={data.data.address} openHour={data.data.open_hour} closeHour={data.data.close_hour} rating={data.data.average_rating} />
                        }    
                    </div>
                    ...
                    <div tw="pb-7 pt-4 px-6 text-xs text-justify w-full">
                        {status === 'success' &&
                            <div tw="flex items-start">
                                ...
                                <div>
                                    <p>Slot Booking: {data.data.min_slot} - {data.data.max_slot}</p>
                    ...
                    <div tw="px-4 pt-10 w-full flex-col items-center">
                        ...
                        }{status==='success' && data.data.reviews.map((review: any, key: any) => (
                            <div key={key} tw="text-center mb-3">
                                <ReviewCard name={review.user} rating={review.rating} content={review.content} />
                            </div>
                        ))}
                    </div>
                </div>
