...
export const placePaginationSuccessResponse2 = {
  status: 200,
  message: 'success',
  data: {
    pagination: {
...
export const mockedResponse: AxiosResponse = {
  data: placePaginationSuccessResponse,
  status: 200,
  statusText: 'OK',
  headers: {},
  config: {},
...
export const mockedResponse2: AxiosResponse = {
  data: placePaginationSuccessResponse2,
  status: 200,
  statusText: 'OK',
  headers: {},
  config: {},
